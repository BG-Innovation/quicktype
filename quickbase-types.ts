...
// App: Copy of BG Software Tracking (bvba8quak)

/**
 * Main application for tracking software projects and users
 */
export interface BgSoftwareApp {
  name: "BgSoftware";
  appId: "bvba8quak";
  ...
  generatedAt: string;
  tables: {
    software?: BgSoftwareSoftwareTable;
    employees?: BgSoftwareEmployeesTable;
    conversations?: BgSoftwareConversationsTable;
    projects?: BgSoftwareProjectsTable;
    projectdeployments?: BgSoftwareProjectdeploymentsTable;
  };
}
export interface BgSoftwareSoftwareTable {
  tableId: string;
  displayName: string;
  friendlyName: string;
  fields: {
...
export interface BgSoftwareEmployeesTable {
  tableId: string;
  displayName: string;
  friendlyName: string;
  fields: {
...
export interface BgSoftwareConversationsTable {
  tableId: string;
  displayName: string;
  friendlyName: string;
  fields: {
...
export interface BgSoftwareProjectsTable {
  tableId: string;
  displayName: string;
  friendlyName: string;
  fields: {
...
export interface BgSoftwareProjectdeploymentsTable {
  tableId: string;
  displayName: string;
  friendlyName: string;
  fields: {
...
export interface BgSoftwareEmployeesData {
  id?: number | string;
  entraid?: string;
  firstName?: string;
  lastName?: string;
...
export interface BgSoftwareConversationsData {
  id?: number | string;
  softwarename?: string;
...
export interface BgSoftwareProjectsData {
  id?: number | string;
  projectName?: string;
  regionname?: string;
  divisionname?: string;
...
export interface BgSoftwareProjectdeploymentsData {
  id?: number | string;
  projectName?: string;
  softwarename?: string;
...
export interface Config {
  ...
  tableData: {
  BgSoftware: {
    software: BgSoftwareSoftwareData;
    employees: BgSoftwareEmployeesData;
    conversations: BgSoftwareConversationsData;
    projects: BgSoftwareProjectsData;
    projectdeployments: BgSoftwareProjectdeploymentsData;
  };
  };
}
