 ...
 */
export declare function buildConfig(config: QuickBaseConfig): QuickBaseConfig;
/**
 ...
 */
export type GetAppByName<TConfig extends QuickBaseConfig, TName extends ExtractAppNames<TConfig>> = Extract<TConfig['apps'][number], {
    name: TName;
}>;
